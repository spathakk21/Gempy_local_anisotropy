...
if __name__ == "__main__":
    ...
    ####
    df_sp = pd.read_csv(os.path.join(BASE_DIR, "exp2_only fault rotation_surfaces.csv"))
    df_op = pd.read_csv(os.path.join(BASE_DIR, "exp2_only fault rotation_orientation.csv"))
    ...
    #### SAVING THE DATA (scaled points between 0 and 1)
