...
if __name__ == "__main__":
    ...
    'fault': torch.tensor([
       [400.0, 200.0, 800.0, 0.0],
        ...
        # Rotating the fault to straight vertical plane at T =5.0

        [500.0, 200.0, 800.0, 5000.0],
        [500.0, 500.0, 800.0, 5000.0],
        [500.0, 800.0, 800.0, 5000.0],
        
        # Middle of the fault
        [500.0, 200.0, 500.0, 5000.0],
        [500.0, 500.0, 500.0, 5000.0],
        [500.0, 800.0, 500.0, 5000.0],
        
        # Bottom edge of the fault 
        [500.0, 200.0, 100.0, 5000.0],
    ...
    struct_orientation_data = {
       "Positions": torch.tensor([
        ...
        # Right Block flattened
        [850.0, 500.0, 520.0, 5000.0],
        ...
        # Right Block flattened
        [850.0, 500.0, 500.0, 10000.0],
        [700.0, 500.0, 500.0, 10000.0],
        [1200.0, 500.0, 500.0, 10000.0],

        ]) / 1000, 
    "Values": torch.tensor([
        
        # --- Original inclined normal vectors at T=0 ---
        # Left Block
